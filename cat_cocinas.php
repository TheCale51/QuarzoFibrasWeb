...
<html lang="es">
    <head>
        ...
        <body>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <p class="CatTitulo">Cocinas</p>
                </div>
                <div class="col-sm-6 imgcat">
                    <img src="img/Cocinas-1.jpg">
                    <img src="img/Cocinas-2.jpg">
                    <img src="img/Cocinas-3.jpg">
                </div>
                <div class="col-sm-6 imgcat">
                    <img src="img/Cocinas-4.jpg">
                    <img src="img/Cocinas-5.jpg">
                    <img src="img/Cocinas-6.jpg">
                </div>
            </div>
        </body>
