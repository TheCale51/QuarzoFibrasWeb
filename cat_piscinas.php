...
<html lang="es">
    <head>
        ...
        <body>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <p class="CatTitulo">Piscinas</p>
                </div>
                <div class="col-sm-6 imgcat">
                    <img src="img/Piscinas-1.jpg">
                    <img src="img/Piscinas-2.jpg">
                    <img src="img/Piscinas-3.jpg">
                </div>
                <div class="col-sm-6 imgcat">
                    <img src="img/Piscinas-4.jpg">
                    <img src="img/Piscinas-5.jpg">
                    <img src="img/Piscinas-6.jpg">
                </div>
            </div>
        </body>
