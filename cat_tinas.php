...
<html lang="es">
    <head>
        ...
        <body>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <p class="CatTitulo">Tinas</p>
                </div>
                <div class="col-sm-6 imgcat">
                    <img src="img/Tinas-1.jpg">
                    <img src="img/Tinas-2.jpg">
                    <img src="img/Tinas-3.jpg">
                </div>
                <div class="col-sm-6 imgcat">
                    <img src="img/Tinas-4.jpg">
                    <img src="img/Tinas-5.jpg">
                    <img src="img/Tinas-6.jpg">
                </div>
            </div>
        </body>
