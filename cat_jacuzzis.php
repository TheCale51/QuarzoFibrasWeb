...
<html lang="es">
    <head>
        ...
        <body>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <p class="CatTitulo">Jacuzzis</p>
                </div>
                <div class="col-sm-6 imgcat">
                    <img src="img/Jacuzzis-1.jpg">
                    <img src="img/Jacuzzis-2.jpg">
                    <img src="img/Jacuzzis-3.jpg">
                </div>
                <div class="col-sm-6 imgcat">
                    <img src="img/Jacuzzis-4.jpg">
                    <img src="img/Jacuzzis-5.jpg">
                    <img src="img/Jacuzzis-6.jpg">
                </div>
            </div>
        </body>
