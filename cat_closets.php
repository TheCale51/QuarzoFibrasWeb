...
<html lang="es">
    <head>
        ...
        <body>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <p class="CatTitulo">Closets</p>
                </div>
                <div class="col-sm-6 imgcat">
                    <img src="img/Closets-1.jpg">
                    <img src="img/Closets-2.jpg">
                    <img src="img/Closets-3.jpg">
                </div>
                <div class="col-sm-6 imgcat">
                    <img src="img/Closets-4.jpg">
                    <img src="img/Closets-5.jpg">
                    <img src="img/Closets-6.jpg">
                </div>
            </div>
        </body>
