...
<html lang="es">
    <head>
        ...
        <body>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <p class="CatTitulo">Baños</p>
                </div>
                <div class="col-sm-6 imgcat">
                    <img src="img/Baños-1.jpg">
                    <img src="img/Baños-2.jpg">
                    <img src="img/Baños-3.jpg">
                </div>
                <div class="col-sm-6 imgcat">
                    <img src="img/Baños-4.jpg">
                    <img src="img/Baños-5.jpg">
                    <img src="img/Baños-6.jpg">
                </div>
            </div>
        </body>
