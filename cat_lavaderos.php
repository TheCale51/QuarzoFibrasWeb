...
<html lang="es">
    <head>
        ...
        <?php 
            ...
            <div class="row">
                <div class="col-sm-12">
                    <p class="CatTitulo">Lavaderos</p>
                </div>
                <div class="col-sm-6 imgcat">
                    <img src="img/Lavaderos-1.jpg">
                    <img src="img/Lavaderos-2.jpg">
                    <img src="img/Lavaderos-3.jpg">
                </div>
                <div class="col-sm-6 imgcat">
                    <img src="img/Lavaderos-4.jpg">
                    <img src="img/Lavaderos-5.jpg">
                    <img src="img/Lavaderos-6.jpg">
                </div>
            </div>
        </body>
