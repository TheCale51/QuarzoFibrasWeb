...
<html lang="es">
    <head>
        ...
        <body>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <p class="CatTitulo">Lavamanos</p>
                </div>
                <div class="col-sm-6 imgcat">
                    <img src="img/Lavamanos-1.jpg">
                    <img src="img/Lavamanos-2.jpg">
                    <img src="img/Lavamanos-3.jpg">
                </div>
                <div class="col-sm-6 imgcat">
                    <img src="img/Lavamanos-4.jpg">
                    <img src="img/Lavamanos-5.jpg">
                    <img src="img/Lavamanos-6.jpg">
                </div>
            </div>
        </body>
